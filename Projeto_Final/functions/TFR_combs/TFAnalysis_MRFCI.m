function [combined_TFR_MRFCI, f, t] = TFAnalysis_MRFCI(x,fs)
    ...
    %% - - - - - - Parameters configuration - - - - - - 
        ...
        Nf = [1024 2048 3072 4096 8192]; % Window sizes
        asym_flags = [0 0 0 0 1]; % Indicate which Nf will be used to compute Fan-chirp instances
        FChT_flags = [0 0 0 1 1]; % Indicate which Nf will be used to compute Fan-chirp instances
